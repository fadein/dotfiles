...
PAYLOAD_FILES="ackrc csirc dircolors gitconfig inputrc Xdefaults xinitrc xprofile config/user-dirs.locale config/picom.conf config/user-dirs.dirs config/gtk-3.0/settings.ini"
